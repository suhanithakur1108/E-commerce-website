  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] flex items-center justify-center px-4 py-10">
      <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl shadow-2xl p-10 w-full max-w-5xl">
        <h2 className="text-4xl font-bold text-white text-center mb-10">Get in Touch with <span className="text-red-400">Kartly</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="text-white space-y-6">
            ...
            <div>
              <p><strong><FaMapMarkerAlt  style={{ display: 'inline', marginRight: '8px' }} /> Address:</strong> Vadodara, Gujarat, India</p>
              <p><strong><FaEnvelope style={{ display: 'inline', marginRight: '8px' }} /> Email:</strong> support@Kartly.com</p>
              <p><strong><FaPhone  style={{ display: 'inline', marginRight: '8px' }}/> Phone:</strong> +91 987654321</p>
            </div>
          </div>
